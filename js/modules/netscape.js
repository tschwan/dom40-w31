            ...
            <div style="display: flex; flex-direction: column; gap: 6px;">
                ...
                <div class="retro-sunken" style="background: #c0c0c0; padding: 4px; display: flex; flex-direction: column; gap: 4px;">
                    <div style="display: flex; flex-wrap: wrap; gap: 4px; align-items: center;">
                        ...
                        <div style="margin-left: auto; width: 26px; height: 26px; background: #000080; color: #00ff66; display: flex; align-items: center; justify-content: center; font-weight: bold; border: 1px solid #000000; flex-shrink: 0;">
                            N
                        </div>
                    </div>

                    <div style="display: flex; align-items: center; gap: 6px; font-size: 11px; min-width: 0;">
                        <span style="font-weight: bold; flex-shrink: 0;">Adresse:</span>
                        <div class="retro-sunken" style="flex: 1; min-width: 0; background: #ffffff; padding: 2px 6px; font-family: monospace; font-size: 11px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                ...
                <div class="retro-sunken" style="background: #000033; color: #ffff00; padding: 16px; max-height: 420px; overflow-y: auto; overflow-x: hidden; font-family: 'Comic Sans MS', cursive, sans-serif;">
                    <!-- Marquee Ticker -->
                    <div style="background: #ff0000; color: #ffffff; padding: 4px; font-weight: bold; margin-bottom: 14px; border: 2px dashed #ffff00; text-align: center; overflow: hidden;">
                    ...
                    <div style="text-align: center; margin-bottom: 14px;">
                        ...
                        <h2 style="font-size: 20px; color: #00ffff; text-shadow: 2px 2px #ff00ff; margin-bottom: 4px; word-break: break-word;">
